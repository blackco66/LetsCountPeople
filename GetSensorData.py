...
time_interval = 10
url_post = 'http://countwebservice-env.eba-mgxywmfq.ap-northeast-2.elasticbeanstalk.com/pages/get_data/'
url_login = 'http://countwebservice-env.eba-mgxywmfq.ap-northeast-2.elasticbeanstalk.com/accounts/login/'
gym_id = 0
